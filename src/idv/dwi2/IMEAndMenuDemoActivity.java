...
public class IMEAndMenuDemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		editText2
				.setOnEditorActionListener(new BasicEditorActionListener("送!!"));
		editText3 = (EditText) findViewById(R.id.editText3);
		editText3.setOnEditorActionListener(new BasicEditorActionListener());
		editText6 = (EditText) findViewById(R.id.editText6);
		editText6
				.setOnEditorActionListener(new BasicEditorActionListener("去!!"));
		isPasswordVisible = false;

		registerForContextMenu(findViewById(R.id.scrollView1));
	}
		...
		case R.id.submenu:
			if (theMenu != null) {
				...
				if (isPasswordVisible) {
					Log.i(TAG, "isPasswordVisible=" + isPasswordVisible
							+ " set R.id.visible_password as checked");
					checkedItem = (MenuItem) theMenu
							.findItem(R.id.visible_password);
				} else {
					Log.i(TAG, "isPasswordVisible=" + isPasswordVisible
							+ " set R.id.invisible_password as checked");
					checkedItem = (MenuItem) theMenu
							.findItem(R.id.invisible_password);
				}
	...
	private void setupPasswordVisibility() {
		Log.i(TAG, "setupPasswordVisibility()");
